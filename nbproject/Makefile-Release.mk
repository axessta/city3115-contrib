...
${OBJECTDIR}/cvtColour.o: cvtColour.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cvtColour.o cvtColour.cpp

${OBJECTDIR}/edgeDetection.o: edgeDetection.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/edgeDetection.o edgeDetection.cpp

${OBJECTDIR}/gaussianMixtureModels.o: gaussianMixtureModels.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gaussianMixtureModels.o gaussianMixtureModels.cpp
...
${OBJECTDIR}/opticalFlow.o: opticalFlow.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/opticalFlow.o opticalFlow.cpp
